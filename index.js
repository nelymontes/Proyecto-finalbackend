...
app.get('/api/v1/tareas', async (req, res) => {
    ...
    let filtro = {}
    if (estado === 'activa' || estado === 'inactiva' || estado === 'finalizado') {
...
app.put('/api/v1/tareas/:id', async (req, res) => {
    ...
    if (tasksData.titulo) {
        modificacion.titulo = tasksData.titulo
    }
    if (tasksData.estado) {
        modificacion.estado = tasksData.estado
    }
    if (tasksData.descripcion) {
        modificacion.descripcion = tasksData.descripcion
    }
    if (tasksData.responsable) {
        modificacion.responsable = tasksData.responsable
    }
